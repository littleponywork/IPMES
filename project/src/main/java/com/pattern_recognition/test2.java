...
import com.pattern_recognition.Event;
...
public class test2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ------ Create pattern "a b+" ------
        Pattern<Event, ?> pattern = Pattern.<Event>begin("start", skipStrategy)
                .where(SimpleCondition.of(value -> value.getName().startsWith("a"))).followedBy("next")
                .where(SimpleCondition.of(value -> value.getName().startsWith("b"))).oneOrMore()
                .consecutive();
